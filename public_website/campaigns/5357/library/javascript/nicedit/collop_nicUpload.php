...
$domain = $_SERVER['HTTP_HOST'] == 'campaign.dev' ? 'campaign.dev' : 'collop.co.za';

define('NICUPLOAD_PATH', $_SERVER['DOCUMENT_ROOT'].'/templates/comms/COLLOP/images-custom/'); // Set the path (relative or absolute) to
                                      // the directory to save image files
                                      
define('NICUPLOAD_URI', 'http://'.$domain.'/templates/comms/COLLOP/images-custom');   // Set the URL (relative or absolute) to
