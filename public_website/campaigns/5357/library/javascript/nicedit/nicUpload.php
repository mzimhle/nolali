...
if(!is_dir($_SERVER['DOCUMENT_ROOT'].$zfsession->domainData['campaign_directory'].'/images/newsletters/')) mkdir($_SERVER['DOCUMENT_ROOT'].$zfsession->domainData['campaign_directory'].'/images/newsletters/', 0777, true);

define('NICUPLOAD_PATH', $_SERVER['DOCUMENT_ROOT'].$zfsession->domainData['campaign_directory'].'/images/newsletters/'); // Set the path (relative or absolute) to
                                      // the directory to save image files
                                      
define('NICUPLOAD_URI', 'http://'.$zfsession->domainData['campaign_domain'].$zfsession->link.'images/newsletters');   // Set the URL (relative or absolute) to
