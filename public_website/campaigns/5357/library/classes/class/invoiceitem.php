   ...
   //declare table variables
	...
	public function getByCode($code) {
		$select = $this->_db->select()	
					->from(array('invoiceitem' => 'invoiceitem'), array('invoiceitem_code','price_code','invoice_code','invoiceitem_name','invoiceitem_description','invoiceitem_quantity','invoiceitem_amount',new Zend_Db_Expr("(invoiceitem_quantity * invoiceitem_amount) AS invoiceitem_total")))	
