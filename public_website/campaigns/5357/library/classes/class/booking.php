   ...
   //declare table variables
	...
	public function getAll()
	{
		...
		$select = $this->_db->select()	
					->from(array('booking' => 'booking'))	
					->joinLeft(array('campaign' => 'campaign'), 'campaign.campaign_code = booking.campaign_code', array())
					->joinLeft(array('_priceitem' => '_priceitem'), "booking.booking_code = _priceitem_reference and _priceitem_type = 'BOOKING'", array())
					->joinLeft(array('_price' => '_price'), "_price._price_code = _priceitem._price_code and _price_product = 'PRODUCTITEM'")
					->joinLeft(array('productitem' => 'productitem'), "productitem.productitem_code = _price._price_reference")
					->where('booking_deleted = 0 and campaign_deleted  = 0 and _price_deleted = 0 and _priceitem._priceitem_deleted = 0')
					->where($this->_campaign->_campaignsql)
