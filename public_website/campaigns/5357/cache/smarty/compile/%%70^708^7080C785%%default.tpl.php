<?php /* Smarty version 2.6.20, created on 2015-05-27 14:46:36
...
<head>
 ...
 - Contact Us</title>
	<meta name="keywords" content="contact us, inquiry form, guest house, complaints, comments, south africa, thornton cape town, bed and breakfast, western cape, accomodation">
...
smarty_core_smarty_include_php(array('smarty_file' => "includes/header.php", 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
	...
	<div id="main">
		<h2>Contact <?php echo $this->_tpl_vars['campaign']['campaign_name']; ?>
!</h2>		
		...
		<div id="contact-area">			
			<form method="post" action="/contact/" name="detailsForm" id="detailsForm">
				<table>
					<tr>
						<td class="left">
							<label for="inquiry_name">Full name:</label>
							<?php if (isset ( $this->_tpl_vars['errorArray']['inquiry_name'] )): ?><em class="error"><?php echo $this->_tpl_vars['errorArray']['inquiry_name']; ?>
</em><?php endif; ?>
						</td>
						<td><input type="text" name="inquiry_name" id="inquiry_name" value="" /></td>
					</tr>
					<tr>
						<td class="left">
					...
					<tr>
						<td class="left">
							...
							<?php if (isset ( $this->_tpl_vars['errorArray']['inquiry_email'] )): ?><em class="error"><?php echo $this->_tpl_vars['errorArray']['inquiry_email']; ?>
</em><?php endif; ?>
						</td>
						<td><input type="text" name="inquiry_email" id="inquiry_email" value="" /></td>
					</tr>
					<tr>
						<td class="left">
							<label for="inquiry_number">Cellphone :</label>
							<?php if (isset ( $this->_tpl_vars['errorArray']['inquiry_number'] )): ?><br /><em class="error"><?php echo $this->_tpl_vars['errorArray']['inquiry_number']; ?>
</em><?php else: ?><em>(Optional e.g. 0735698741)<?php endif; ?>
						</td>
						<td><input type="text" name="inquiry_number" id="inquiry_number" value="" /></td>
					</tr>
					<tr>
						<td class="left">
							<label for="inquiry_subject">Subject :</label>
							<?php if (isset ( $this->_tpl_vars['errorArray']['inquiry_subject'] )): ?><em class="error"><?php echo $this->_tpl_vars['errorArray']['inquiry_subject']; ?>
</em><?php endif; ?>
						</td>
						<td>
							<select name="inquiry_subject" id="inquiry_subject">
					...
					<tr>
						<td class="left" valign="top">
							<label for="inquiry_comments">Message:</label>
							<?php if (isset ( $this->_tpl_vars['errorArray']['inquiry_comments'] )): ?><em class="error"><?php echo $this->_tpl_vars['errorArray']['inquiry_comments']; ?>
</em><?php endif; ?>
						</td>
						<td><textarea name="inquiry_comments" id="inquiry_comments" rows="20" cols="20"></textarea></td>
					</tr>
				</table>	
				...
				<?php if (isset ( $this->_tpl_vars['errorArray']['inquiry_captcha'] )): ?><em class="error">Incorrect captcha details, please fill in the correct characters in the box.</em><?php endif; ?>
				<br /><br />
