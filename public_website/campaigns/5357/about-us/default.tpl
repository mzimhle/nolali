...
<head>
	...
	<title>{$campaign.campaign_name} - About Us</title>
...
<div id="wrap">
	...
	<div id="main">
		<h2>About {$campaign.campaign_name}!</h2>		
		<img class="img-indent pimg" alt="{$campaign.campaign_name} is happy to welcome you!" src="/images/nqulelwa-mzana.jpg" />  
		<p class="alt-top">
