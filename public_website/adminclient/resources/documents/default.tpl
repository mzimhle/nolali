...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	<head>
		...
		<title>{$domainData.campaign_company}| Admin | Resources | Documents</title>
	</head>
	<body>
		<div id="wrapper">
			...
			<p class="linebreak"></p>
			<div id="main">
				<a class="link" href="/admin/resources/documents/details.php">Add a New Documents</a>
				<div id="tableContent" align="center">
					<!-- Start Content Table -->
					<div class="content_table">
						<form name="htmlForm" id="htmlForm" action="/admin/resources/documents/" method="post">
							<table border="0" cellspacing="0" cellpadding="0" id="dataTable">							
							  ...
							  <tr>
								...
								<td align="left"><a href="/admin/resources/documents/details.php?code={$item.campaigndocument_code}">{$item.campaigndocument_name}</a></td>
