...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	<head>
		...
		<title>{$domainData.campaign_company} Admin | Resources | Documents | {$campaigndocumentData.campaigndocument_name}</title>
	</head>
	<body>
		<div id="wrapper">
			...
			<p class="breadcrum">
				...
				<a href="/admin/resources/documents/details.php?code={$campaigndocumentData.campaigndocument_code}">{$campaigndocumentData.campaigndocument_name}</a> &raquo; 
				<a href="#">Documents</a>
			</p>			
			<div id="main">
				<div class="clr"></div>
				...
				<div id="tableContent" align="center">				
					...
					<div class="content_table">
						<form name="detailsForm" id="detailsForm" action="/admin/resources/documents/item.php?code={$campaigndocumentData.campaigndocument_code}" method="post">
						<table id="grid_table" border="0" cellspacing="0" cellpadding="0">
						  ...
						  <tr>							  
							...
							<td align="left" class="alt">
								<textarea name="campaigndocumentitem_description_{$item.campaigndocumentitem_code}" id="campaigndocumentitem_description_{$item.campaigndocumentitem_code}" cols="30" rows="5">{$item.campaigndocumentitem_description}</textarea>
							</td>		
							<td align="left" class="alt">
					...
					<h3>Add a document item</h3><span class="selecteditem">Please only add pdf, xls, txt, docx, doc, cvs, jpg, jpeg, gif and png</span>
					<div id="tableContent" align="center">		
					<div class="content_table">		
					<form name="additemForm" id="additemForm" action="/admin/resources/documents/item.php?code={$campaigndocumentData.campaigndocument_code}" method="post"  enctype="multipart/form-data">					
						<table id="grid_table" border="0" cellspacing="0" cellpadding="0">
						  <tr>
						  ...
						  <tr>		
							...
							<td align="left" class="alt">
								<input type="text" name="campaigndocumentitem_name" id="campaigndocumentitem_name" size="40" />
							</td>							
							<td align="left" class="alt">
								<textarea name="campaigndocumentitem_description" id="campaigndocumentitem_description" rows="5" cols="30"></textarea>
							</td>	
							<td colspan="2">
