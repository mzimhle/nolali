...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	<head>
		...
		<title>Enquiries | {$domainData.campaign_company}</title>
	</head>
	<body>
		<div id="wrapper">
			...
			<div id="main">
				<div id="tableContent" align="center">
					...
					<div class="content_table">
						<form name="htmlForm" id="htmlForm" action="/admin/enquiries/" method="post">
							<table border="0" cellspacing="0" cellpadding="0" id="dataTable">							
							  ...
							  <tr>
								...
								<td align="left"><a href="/admin/enquiries/details.php?code={$item.enquiry_code}">{$item.enquiry_name}</a></td>	
