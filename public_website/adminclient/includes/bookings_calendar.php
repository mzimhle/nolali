...
if($bookingData) {
	foreach($bookingData as $item) {
		...
		$bookingCalendar[$i]['title']			= $item['participant_name'].' '.$item['participant_name'].' - Booked for '.$item['product_name'];
		$bookingCalendar[$i]['url']				= '/admin/daily-bookings/details.php?code='.$item['booking_code'];
