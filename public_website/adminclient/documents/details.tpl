...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
	...
	<body>
		<div id="wrapper">
			...
			<p class="linebreak"></p>
			<div id="main">
				<form id="detailsForm" name="detailsForm" action="/admin/documents/details.php{if isset($campaigndocumentData)}?code={$campaigndocumentData.campaigndocument_code}{/if}" method="post">
				<div class="col">				
					<div class="article">
					...
					<div class="article">
						...
						<p class="short">
							<textarea id="campaigndocument_description" name="campaigndocument_description" rows="15" cols="40">{$campaigndocumentData.campaigndocument_description}</textarea>		
						</p>						
					</div>					
					<div class="article">
						<p class="short">
				...
				<div class="col">
					<div class="article">
						<h4><a href="{if isset($campaigndocumentData)}/admin/documents/item.php?code={$campaigndocumentData.campaigndocument_code}{else}#{/if}">Documents</a></h4>
						<p class="short line">
