...
require_once 'class/ADMIN/calendar.php';

$calendarObject	= new class_wn_calendar();
...
if($calendarData) {
	foreach($calendarData as $item) {
		...
		$calendar[$i]['url']				= '/administration/internal/calendar/schedules/details.php?code='.$item['calendar_code'];
