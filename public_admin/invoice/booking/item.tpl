    ...
    <div class="slim-mainpanel">
      <div class="container">
		...
		<ul class="nav nav-activity-profile mg-t-20">
			<li class="nav-item">
				<a href="/invoice/booking/details.php?id={$invoiceData.invoice_id}" class="nav-link"><i class="icon ion-ios-redo tx-purple"></i> Details</a>
			</li>
			<li class="nav-item">
				<a href="/invoice/booking/item.php?id={$invoiceData.invoice_id}" class="nav-link"><i class="icon ion-ios-redo tx-purple"></i> Booking</a>
			</li>		
		</ul>
        <div class="section-wrapper card card-latest-activity mg-t-20">
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 mg-t-20 mg-md-t-0-force">
                    ...
                    <form action="/invoice/booking/item.php?id={$invoiceData.invoice_id}" method="POST">
