<?php
/* Smarty version 3.1.34-dev-7, created on 2022-09-05 20:42:05
  from 'C:\sites\nolali.loc\public_admin\content\event\default.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_631642fdafb620_60235932',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2984ace93a3cecfc50fd95b87eef1ede185044c8' => 
    array (
      0 => 'C:\\sites\\nolali.loc\\public_admin\\content\\event\\default.tpl',
      1 => 1661979274,
      2 => 'file',
...
function content_631642fdafb620_60235932 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <div class="slim-mainpanel">
      <div class="container">
        <div class="slim-pageheader">
          ...
          <h6 class="slim-pagetitle">Events</h6>
        </div><!-- slim-pageheader -->
        <div class="section-wrapper">
		  <label class="section-title">List</label>
            <p class="mg-b-20 mg-sm-b-20">Below is a list of events you have added.</p>
            <div class="row">
                <div class="col-md-12">					
                    <div class="row">
                        <div class="col-sm-12">				
                    ...
                    <div class="form-group">
                        ...
                        <button class="btn btn-secondary fr" type="button" onclick="link('/content/event/details.php'); return false;">Add a new event</button>
                    </div>
...
>
 ...
 type="text/javascript">
    ...
    function getRecords() {
        ...
        $('#tableContent').html('');
        $('#tableContent').html('<table cellpadding="0" cellspacing="0" width="100%" border="0" class="display" id="dataTable"><thead><tr><th></th><th>Name</th><th>Start</th><th>End</th><th></th></tr></thead><tbody id="contentbody"><tr><td colspan="3" align="center"></td></tr></tbody></table>');	
