<?php
/* Smarty version 3.1.34-dev-7, created on 2022-09-06 21:54:30
  from 'C:\sites\nolali.loc\public_admin\template\default.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_6317a576423911_01810320',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '590b39f0f74712fcf0cfac0a364d50a5ff60c36e' => 
    array (
      0 => 'C:\\sites\\nolali.loc\\public_admin\\template\\default.tpl',
      1 => 1632158439,
      2 => 'file',
...
function content_6317a576423911_01810320 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
  <head>
      ...
      <div class="container">
        <div class="slim-pageheader">
          <ol class="breadcrumb slim-breadcrumb">
            ...
            <?php if (isset($_smarty_tpl->tpl_vars['activeAccount']->value)) {?><li class="breadcrumb-item"><a href="/"><?php echo $_smarty_tpl->tpl_vars['activeAccount']->value['account_name'];?>
</a></li><?php }?>
        ...
        <div class="section-wrapper">
		  <label class="section-title">Templates</label>
            <p class="mg-b-20 mg-sm-b-20">Below is a list of templates you have added.</p>
            <div class="row">
                <div class="col-md-12">					
					<div class="row">						
						<div class="col-sm-12">				
					...
					<div class="form-group">
						...
						<button class="btn btn-secondary fr" type="button" onclick="link('/template/details.php'); return false;">Add a new template</button>
					</div>
 ...
 type="text/javascript">
    ...
    function getRecords() {
        ...
        $('#tableContent').html('');
        $('#tableContent').html('<table cellpadding="0" cellspacing="0" width="100%" border="0" class="display" id="dataTable"><thead><tr><th>Cipher</th><th>Category</th><th>View</th><th></th></tr></thead><tbody id="productbody"><tr><td colspan="6" align="center"></td></tr></tbody></table>');	
