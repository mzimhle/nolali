<?php /* Smarty version 2.6.20, created on 2015-05-15 19:39:34
         compiled from website/catalogue/product/image.tpl */ ?>
...
</span> Product Images</h2><br />
		<div id="sidetabs">
		<ul> 
            <li><a href="/website/catalogue/product/details.php?code=<?php echo $this->_tpl_vars['productData']['product_code']; ?>
" title="Details">Details</a></li>
			<li class="active"><a href="#" title="Images">Images</a></li>
		</ul>
		</div><!--tabs-->	
		  <div class="detail_box">  
		  <form name="imageForm" id="imageForm" action="/website/catalogue/product/image.php?code=<?php echo $this->_tpl_vars['productData']['product_code']; ?>
...
?>
			  <tr>	
				<td valign="top"<?php if ($this->_tpl_vars['item']['productimage_primary'] == '1'): ?>class="success"<?php endif; ?>><?php echo $this->_tpl_vars['item']['productimage_description']; ?>
</td>	
				<td valign="top">
...
" />
				...
				<td valign="top"><?php if ($this->_tpl_vars['item']['productimage_primary'] == '0'): ?><button type="button" onclick="deleteitem('<?php echo $this->_tpl_vars['item']['productimage_code']; ?>
'); return false;">Delete</button><?php else: ?><b>Primary</b><?php endif; ?></td>	
				<td valign="top"><?php if ($this->_tpl_vars['item']['productimage_primary'] == '0'): ?><button type="button" onclick="makeprimary('<?php echo $this->_tpl_vars['item']['productimage_code']; ?>
...
<?php echo '",
				...
				success: function(data){
						if(data.result == 1) {
							alert(\'Changed\');
							window.location.href = \'/website/catalogue/product/image.php?code='; ?>
<?php echo $this->_tpl_vars['productData']['product_code']; ?>
<?php echo '\';
						} else {
							alert(data.message);
