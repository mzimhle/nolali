<?php /* Smarty version 2.6.20, created on 2015-05-15 17:40:14
         compiled from website/product/details.tpl */ ?>
...
smarty_core_smarty_include_php(array('smarty_file' => 'includes/header.php', 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
	...
	<div id="breadcrumb">
        <ul>
			...
			<li><a href="/website/product/" title="">Products</a></li>
    ...
    <div id="sidetabs">
        <ul > 
			...
			<li><a href="<?php if (isset ( $this->_tpl_vars['productData'] )): ?>/website/product/items.php?code=<?php echo $this->_tpl_vars['productData']['product_code']; ?>
<?php else: ?>#<?php endif; ?>" title="Items">Items</a></li>
			<li><a href="<?php if (isset ( $this->_tpl_vars['productData'] )): ?>/website/product/prices.php?code=<?php echo $this->_tpl_vars['productData']['product_code']; ?>
<?php else: ?>#<?php endif; ?>" title="Prices">Prices</a></li>
			<li><a href="<?php if (isset ( $this->_tpl_vars['productData'] )): ?>/website/product/image.php?code=<?php echo $this->_tpl_vars['productData']['product_code']; ?>
<?php else: ?>#<?php endif; ?>" title="Images">Images</a></li>
        </ul>
    </div><!--tabs-->

	<div class="detail_box">
      <form id="detailsForm" name="detailsForm" action="/website/product/details.php<?php if (isset ( $this->_tpl_vars['productData'] )): ?>?code=<?php echo $this->_tpl_vars['productData']['product_code']; ?>
...
" size="80"/>
        ...
        <div class="mrg_top_10">
          <a href="/website/product/" class="button cancel mrg_left_147 fl"><span>Cancel</span></a>
