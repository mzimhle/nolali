<?php /* Smarty version 2.6.20, created on 2015-06-18 21:00:51
         compiled from website/gallery/view/details.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'website/gallery/view/details.tpl', 49, false),)), $this); ?>
...
smarty_core_smarty_include_php(array('smarty_file' => 'includes/header.php', 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
	...
	<div id="breadcrumb">
        <ul>
			...
			<li><a href="/website/" title="Home">Website</a></li>
    ...
    <div id="sidetabs">
        <ul > 
			...
			<li><a href="<?php if (isset ( $this->_tpl_vars['galleryData'] )): ?>/website/gallery/view/image.php?code=<?php echo $this->_tpl_vars['galleryData']['gallery_code']; ?>
<?php else: ?>#<?php endif; ?>" title="Images">Images</a></li>
        </ul>
    </div><!--tabs-->

	<div class="detail_box">
      <form id="detailsForm" name="detailsForm" action="/website/gallery/view/details.php<?php if (isset ( $this->_tpl_vars['galleryData'] )): ?>?code=<?php echo $this->_tpl_vars['galleryData']['gallery_code']; ?>
...
" size="60"/>
           ...
           <tr>
            <td>
				...
				<select id="gallerytype_code" name="gallerytype_code">
					<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['gallerytypepairs'],'selected' => $this->_tpl_vars['galleryData']['gallerytype_code']), $this);?>
    ...
    <div class="clearer"><!-- --></div>
        <div class="mrg_top_10">
          <a href="/website/gallery/view/" class="button cancel mrg_left_147 fl"><span>Cancel</span></a>
