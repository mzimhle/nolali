<?php /* Smarty version 2.6.20, created on 2015-06-18 23:10:20
         compiled from website/people/view/details.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'website/people/view/details.tpl', 71, false),)), $this); ?>
...
<?php else: ?>Add a Person<?php endif; ?></a></li>
	...
	<div class="detail_box">
      <form id="detailsForm" name="detailsForm" action="/website/people/view/details.php<?php if (isset ( $this->_tpl_vars['participantData'] )): ?>?code=<?php echo $this->_tpl_vars['participantData']['participant_code']; ?>
		  ...
		  <tr>
            <td>
				...
				<select id="participantcategory_code" name="participantcategory_code">
					<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['participantcategorypairs'],'selected' => $this->_tpl_vars['participantData']['participantcategory_code']), $this);?>

				</select>
				<br />
				<?php if (isset ( $this->_tpl_vars['errorArray']['participantcategory_code'] )): ?><em class="error"><?php echo $this->_tpl_vars['errorArray']['participantcategory_code']; ?>
</em><?php endif; ?>
			</td>		  
			<td>
