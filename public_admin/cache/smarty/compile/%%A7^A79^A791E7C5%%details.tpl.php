<?php /* Smarty version 2.6.20, created on 2015-05-17 00:42:51
         compiled from website/booking/view/details.tpl */ ?>
...
smarty_core_smarty_include_php(array('smarty_file' => 'includes/header.php', 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
    ...
    <div id="sidetabs">
        <ul > 
			...
			<li><a href="<?php if (isset ( $this->_tpl_vars['bookingData'] )): ?>/website/booking/view/item.php?code=<?php echo $this->_tpl_vars['bookingData']['booking_code']; ?>
<?php else: ?>#<?php endif; ?>" title="Item">Item</a></li>
        </ul>
    </div><!--tabs-->

	<div class="detail_box">
      <form id="detailsForm" name="detailsForm" action="/website/booking/view/details.php<?php if (isset ( $this->_tpl_vars['bookingData'] )): ?>?code=<?php echo $this->_tpl_vars['bookingData']['booking_code']; ?>
