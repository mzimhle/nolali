<?php /* Smarty version 2.6.20, created on 2015-05-21 21:42:01
         compiled from website/booking/default.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'website/booking/default.tpl', 48, false),)), $this); ?>
...
?>
 ...
 / <?php echo $this->_tpl_vars['item']['booking_person_number']; ?>
				...
				<td align="left">
					<a href="/website/booking/details.php?code=<?php echo $this->_tpl_vars['item']['booking_code']; ?>
" class="<?php if ($this->_tpl_vars['item']['booking_status'] == ''): ?><?php endif; ?><?php if ($this->_tpl_vars['item']['booking_status'] == '0'): ?>error<?php endif; ?><?php if ($this->_tpl_vars['item']['booking_status'] == '1'): ?>success<?php endif; ?>">
