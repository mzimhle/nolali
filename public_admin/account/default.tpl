    ...
    <div class="slim-mainpanel">
      <div class="container">
        ...
        <div class="section-wrapper">
		  <label class="section-title">Account List</label>
            <p class="mg-b-20 mg-sm-b-20">Below is a list of accounts you have added.</p>
            <div class="row">
                <div class="col-md-12">					
				<div class="row">						
					<div class="col-sm-12">				
						<div class="form-group">
							<label for="filter_search">Search by full name, email, cellphone number, etc..</label>
...
function getRecords() {
	...
	$('#tableContent').html('');
	$('#tableContent').html('<table cellpadding="0" cellspacing="0" width="100%" border="0" class="display" id="dataTable"><thead><tr><th></th><th>Name</th><th>Cellphone</th><th>Password</th><th>Email</th></tr></thead><tbody id="accountbody"><tr><td colspan="5" align="center"></td></tr></tbody></table>');	
