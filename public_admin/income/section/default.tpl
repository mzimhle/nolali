...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <div class="slim-pageheader">
          <ol class="breadcrumb slim-breadcrumb">
			<li class="breadcrumb-item active" aria-current="page">Income Section</li>
            <li class="breadcrumb-item"><a href="/">Home</a></li>
          </ol>
          <h6 class="slim-pagetitle">Income Section</h6>
        </div><!-- slim-pageheader -->
        <div class="section-wrapper">
		  <label class="section-title">Income Section</label>
            <p class="mg-b-20 mg-sm-b-20">Below is a list of sections you have added.</p>
            <div class="row">
                <div class="col-md-12">					
                    <div class="row">						
                        <div class="col-sm-12">				
                    ...
                    <div class="form-group">
                        ...
                        <button class="btn btn-secondary fr" type="button" onclick="link('/income/section/details.php'); return false;">Add Income Section</button>
                    </div>
    ...
    function getRecords() {
        ...
        $('#tableContent').html('');
        $('#tableContent').html('<table cellpadding="0" cellspacing="0" width="100%" border="0" class="display" id="dataTable"><thead><tr><th>Name</th><th>Category</th><th>Code</th><th>Calculated</th><th>Direction</th><th></th></tr></thead><tbody id="sectionbody"><tr><td colspan="6" align="center"></td></tr></tbody></table>');	
            ...
            "fnServerData": function ( sSource, aoData, fnCallback ) {
                $.getJSON( sSource, aoData, function (json) {
                    if (json.result === false) {
                        $('#productbody').html('<tr><td colspan="6" align="center">No results</td></tr>');
                    } else {
