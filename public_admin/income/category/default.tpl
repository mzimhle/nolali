...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <div class="slim-pageheader">
          <ol class="breadcrumb slim-breadcrumb">
			<li class="breadcrumb-item active" aria-current="page">Income Category</li>
            <li class="breadcrumb-item"><a href="/">Home</a></li>
          </ol>
          <h6 class="slim-pagetitle">Income Category</h6>
        </div><!-- slim-pageheader -->
        <div class="section-wrapper">
		  <label class="section-title">Income Category</label>
            <p class="mg-b-20 mg-sm-b-20">Below is a list of income categories you have added.</p>
            <div class="row">
                <div class="col-md-12">					
                    <div class="row">						
                        <div class="col-sm-12">				
                    ...
                    <div class="form-group">
                        ...
                        <button class="btn btn-secondary fr" type="button" onclick="link('/income/category/details.php'); return false;">Add income category</button>
                    </div>
    ...
    function getRecords() {
        ...
        $('#tableContent').html('');
        $('#tableContent').html('<table cellpadding="0" cellspacing="0" width="100%" border="0" class="display" id="dataTable"><thead><tr><th>Code</th><th>Name</th><th></th></tr></thead><tbody id="categorybody"><tr><td colspan="2" align="center"></td></tr></tbody></table>');	
