  ...
  <div id="content">
    ...
    <div id="sidetabs">
        <ul > 
			...
			<li><a href="{if isset($galleryData)}/website/gallery/view/image.php?code={$galleryData.gallery_code}{else}#{/if}" title="Images">Images</a></li>
        </ul>
    </div><!--tabs-->

	<div class="detail_box">
      <form id="detailsForm" name="detailsForm" action="/website/gallery/view/details.php{if isset($galleryData)}?code={$galleryData.gallery_code}{/if}" method="post">
           ...
           <tr>
            <td>
				...
				<select id="gallerytype_code" name="gallerytype_code">
					{html_options options=$gallerytypepairs selected=$galleryData.gallerytype_code}
				</select>
				{if isset($errorArray.gallerytype_code)}<br /><em class="error">{$errorArray.gallerytype_code}</em>{/if}
			</td>	
          </tr>			  
          <tr>
            <td>
