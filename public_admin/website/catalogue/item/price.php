...
if(count($_POST) > 0) {
	...
	if(count($errorArray) == 0 && $formValid == true) {
		...
		if($success) {
			header('Location: /website/catalogue/item/price.php?code='.$productitemData['productitem_code']);
			exit;
		}
...
$smarty->display('website/catalogue/item/price.tpl');
