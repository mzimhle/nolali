   ...
   //declare table variables
	...
	public function getByCode($code)
	{
		...
		$select = $this->_db->select()	
					...
					->joinLeft(array('gallerytype' => 'gallerytype'), 'gallery.gallerytype_code = gallerytype.gallerytype_code')
					...
					->where('gallery_deleted = 0 and campaign_deleted = 0 and gallerytype_deleted = 0')
