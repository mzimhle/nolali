    ...
    <div class="slim-mainpanel">
      <div class="container">
        <div class="slim-pageheader">
			...
			<li class="breadcrumb-item"><a href="/content/news/details.php?id={$contentData.content_id}">{$contentData.content_name|truncate:30:"..."}</a></li>
        ...
        <div class="section-wrapper">
          ...
          <div class="row">
			...
			<form action="/content/news/media.php?id={$contentData.content_id}" method="POST" enctype="multipart/form-data">
