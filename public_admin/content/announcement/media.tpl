    ...
    <div class="slim-mainpanel">
      <div class="container">
        <div class="slim-pageheader">
			...
			<li class="breadcrumb-item"><a href="/content/announcement/details.php?id={$contentData.content_id}">{$contentData.content_name}</a></li>
		...
		<ul class="nav nav-activity-profile mg-t-20">
			...
			<li class="nav-item">
				<a href="/content/announcement/price.php?id={$contentData.content_id}" class="nav-link"><i class="icon ion-ios-redo tx-purple"></i> Media</a>
			</li>		
		</ul><br />	
        <div class="section-wrapper">
          ...
          <div class="row">
			...
			<form action="/content/announcement/media.php?id={$contentData.content_id}" method="POST" enctype="multipart/form-data">
				<table class="table table-bordered">	
					...
					{foreach from=$mediaData item=item}
						<tr>
                            <td><img src="{$config.site}{$item.media_path}tny_{$item.media_code}{$item.media_ext}" width="40%" /></td>
