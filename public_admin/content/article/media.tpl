    ...
    <div class="slim-mainpanel">
      <div class="container">
		...
		<ul class="nav nav-activity-profile mg-t-20">
			...
			<li class="nav-item">
				<a href="/content/article/price.php?id={$contentData.content_id}" class="nav-link"><i class="icon ion-ios-redo tx-purple"></i> Media</a>
			</li>		
		</ul><br />	
        <div class="section-wrapper">
          ...
          <div class="row">
			...
			<form action="/content/article/media.php?id={$contentData.content_id}" method="POST" enctype="multipart/form-data">
