    ...
    <div class="slim-mainpanel">
      <div class="container">
        <div class="slim-pageheader">
			...
			<li class="breadcrumb-item"><a href="/commodity/booking/details.php?id={$invoiceData.invoice_id}">{$invoiceData.invoice_code}</a></li>
		...
		<ul class="nav nav-activity-profile mg-t-20">
			<li class="nav-item">
				<a href="/commodity/booking/details.php?id={$invoiceData.invoice_id}" class="nav-link"><i class="icon ion-ios-redo tx-purple"></i> Details</a>
			</li>
			<li class="nav-item">
				<a href="/commodity/booking/item.php?id={$invoiceData.invoice_id}" class="nav-link"><i class="icon ion-ios-redo tx-purple"></i> Booking</a>
			</li>		
		</ul>
        <div class="section-wrapper card card-latest-activity mg-t-20">
			<label class="section-title">Booking of {$invoiceData.invoice_code}</label>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 mg-t-20 mg-md-t-0-force">
                    ...
                    <form action="/commodity/booking/item.php?id={$invoiceData.invoice_id}" method="POST">
