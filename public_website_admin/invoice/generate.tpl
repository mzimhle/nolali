        ...
        <div class="col-sm-9">
          <div class="portlet">
            ...
            <div class="portlet-content">
              <form id="validate-basic" action="/invoice/generate.php?code={$invoiceData.invoice_code}" method="POST" data-validate="parsley" class="form parsley-form" enctype="multipart/form-data">
