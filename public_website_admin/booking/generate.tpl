        ...
        <div class="col-sm-9">
          <div class="portlet">
            ...
            <div class="portlet-content">
              <form id="validate-basic" action="/booking/generate.php?code={$bookingData.booking_code}" method="POST" data-validate="parsley" class="form parsley-form" enctype="multipart/form-data">
				...
				{if $bookingData.invoice_pdf neq ''}
					<p><a href="http://{$domainData.campaign_domain}{$bookingData.invoice_pdf}" target="_blank">Click here for the PDF</a></p>
				{else}
