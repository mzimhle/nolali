      ...
      <div class="row">
        <div class="col-sm-9">
          <div class="portlet">
            ...
            <div class="portlet-content">
              <form id="validate-basic" action="/catalogue/invoice/payment.php?code={$invoiceData.invoice_code}" method="POST" data-validate="parsley" class="form parsley-form" enctype="multipart/form-data">			
				...
				<table class="table table-bordered">	
					...
					{foreach from=$invoicepaymentData item=item}
					  <tr>	
						...
						<td valign="top">{if $item.invoicepayment_file eq ''}N / A{else}<a href="http://{$domainData.campaign_domain}{$item.invoicepayment_file}" target="_blank">Download</a>{/if}</td>					
						<td valign="top">
		...
		<div class="col-sm-3">
			<div class="list-group">  
				...
				<a class="list-group-item" href="/catalogue/invoice/details.php?code={$invoiceData.invoice_code}">
				...
				<a class="list-group-item" href="/catalogue/invoice/generate.php?code={$invoiceData.invoice_code}">
