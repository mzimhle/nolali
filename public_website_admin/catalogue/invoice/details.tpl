        ...
        <div class="col-sm-9">
          <div class="portlet">
            ...
            <div class="portlet-content">
              <form id="validate-basic" action="/catalogue/invoice/details.php{if isset($invoiceData)}?code={$invoiceData.invoice_code}{/if}" method="POST" data-validate="parsley" class="form parsley-form">
