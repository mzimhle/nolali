  ...
  <div class="content">
	...
	<div class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="/catalogue/product/details.php?code={$productData.product_code}">{$productData.product_name}</a></li>
      ...
      <div class="row">
        <div class="col-sm-9">
          <div class="portlet">
            ...
            <div class="portlet-content">
              <form id="validate-basic" action="/catalogue/product/image.php?code={$productData.product_code}" method="POST" data-validate="parsley" class="form parsley-form" enctype="multipart/form-data">			
				...
				<table class="table table-bordered">	
					...
					{foreach from=$productimageData item=item}
						<tr>
							...
							<td>
								{if $item.productimage_primary eq '0'}
									<button value="Make Primary" class="btn btn-danger" onclick="statusSubModal('{$item.productimage_code}', '1', 'image', '{$item.product_code}'); return false;">Make Primary</button>
								{else}
								<b>Primary</b>
								{/if}
							</td>
							<td>
								{if $item.productimage_primary eq '0'}
									<button value="Delete" class="btn btn-danger" onclick="deleteModal('{$item.productimage_code}', '{$item.product_code}', 'image'); return false;">Delete</button>
								{else}
								<b>Primary</b>
								{/if}
							</td>
		...
		<div class="col-sm-3">
			<div class="list-group">
				...
				<a class="list-group-item" href="/catalogue/product/details.php?code={$productData.product_code}">
