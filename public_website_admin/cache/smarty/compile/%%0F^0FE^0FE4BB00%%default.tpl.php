...
<?php echo $this->_tpl_vars['item']['productimage_extension']; ?>
" width="60" />						</a>						<?php else: ?>							<img src="http://www.mailbok.co.za/images/no-image.jpg" width="60" />						<?php endif; ?>											</td>						<td><a href="/catalogue/product/details.php?code=<?php echo $this->_tpl_vars['item']['product_code']; ?>
"><?php echo $this->_tpl_vars['item']['product_name']; ?>
</a></td>						<td><?php echo $this->_tpl_vars['item']['product_description']; ?>
</td>						<td>						<button onclick="deleteModal('<?php echo $this->_tpl_vars['item']['product_code']; ?>
