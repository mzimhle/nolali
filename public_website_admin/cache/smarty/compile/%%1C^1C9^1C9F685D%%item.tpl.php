<?php /* Smarty version 2.6.20, created on 2015-05-22 12:54:05
         compiled from invoice/item.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'number_format', 'invoice/item.tpl', 56, false),)), $this); ?>
<!DOCTYPE html>
        ...
        <div class="col-sm-9">
          <div class="portlet">
            ...
            <div class="portlet-content">
              <form id="validate-basic" action="/invoice/item.php?code=<?php echo $this->_tpl_vars['invoiceData']['invoice_code']; ?>
...
', 'item'); return false;">Delete</button>
                ...
                <div class="form-group">
					...
					<?php if (isset ( $this->_tpl_vars['errorArray']['invoiceitem_name'] )): ?><br /><span class="error"><?php echo $this->_tpl_vars['errorArray']['invoiceitem_name']; ?>
</span><?php endif; ?>					  
                </div>
                <div class="form-group">
					...
					<?php if (isset ( $this->_tpl_vars['errorArray']['invoiceitem_description'] )): ?><br /><span class="error"><?php echo $this->_tpl_vars['errorArray']['invoiceitem_description']; ?>
</span><?php endif; ?>					  
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
					...
					<?php if (isset ( $this->_tpl_vars['errorArray']['invoiceitem_amount'] )): ?><br /><span class="error"><?php echo $this->_tpl_vars['errorArray']['invoiceitem_amount']; ?>
</span><?php endif; ?>					  
                </div>			
		...
		<div class="col-sm-3">
			<div class="list-group">  
				...
				<a class="list-group-item" href="/invoice/details.php?code=<?php echo $this->_tpl_vars['invoiceData']['invoice_code']; ?>
">
				...
				<a class="list-group-item" href="/invoice/payment.php?code=<?php echo $this->_tpl_vars['invoiceData']['invoice_code']; ?>
">
				  <i class="fa fa-file"></i> &nbsp;&nbsp;Payments
				  <i class="fa fa-chevron-right list-group-chevron"></i>
				</a>
				<a class="list-group-item" href="/invoice/generate.php?code=<?php echo $this->_tpl_vars['invoiceData']['invoice_code']; ?>
">
