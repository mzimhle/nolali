<?php /* Smarty version 2.6.20, created on 2015-05-16 13:32:58
         compiled from website/gallery/image.tpl */ ?>
...
smarty_core_smarty_include_php(array('smarty_file' => 'includes/header.php', 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
	...
	<div class="inner">
		...
		<div id="sidetabs">
		<ul> 
            <li><a href="/website/gallery/details.php?code=<?php echo $this->_tpl_vars['galleryData']['gallery_code']; ?>
" title="Details">Details</a></li>
			<li class="active"><a href="#" title="Images">Images</a></li>
		</ul>
		</div><!--tabs-->	
		  <div class="detail_box">  
		  <form name="imageForm" id="imageForm" action="/website/gallery/image.php?code=<?php echo $this->_tpl_vars['galleryData']['gallery_code']; ?>
...
<?php echo '",
				...
				success: function(data){
						if(data.result == 1) {
							alert(\'Changed\');
							window.location.href = \'/website/gallery/image.php?code='; ?>
<?php echo $this->_tpl_vars['galleryData']['gallery_code']; ?>
<?php echo '\';
						} else {
							alert(data.message);
