<?php /* Smarty version 2.6.20, created on 2015-05-26 12:28:37
         compiled from catalogue/item/image.tpl */ ?>
<!DOCTYPE html>
        ...
        <div class="col-sm-9">
          <div class="portlet">
            ...
            <div class="portlet-content">
              <form id="validate-basic" action="/catalogue/item/image.php?code=<?php echo $this->_tpl_vars['productitemData']['productitem_code']; ?>
...
" width="60" />
							...
							<td>
								<?php if ($this->_tpl_vars['item']['productitemimage_primary'] == '0'): ?>
									<button value="Make Primary" class="btn btn-danger" onclick="statusSubModal('<?php echo $this->_tpl_vars['item']['productitemimage_code']; ?>
', '1', 'image', '<?php echo $this->_tpl_vars['item']['productitem_code']; ?>
'); return false;">Make Primary</button>
							...
							<td>
								<?php if ($this->_tpl_vars['item']['productitemimage_primary'] == '0'): ?>
									<button value="Delete" class="btn btn-danger" onclick="deleteModal('<?php echo $this->_tpl_vars['item']['productitemimage_code']; ?>
