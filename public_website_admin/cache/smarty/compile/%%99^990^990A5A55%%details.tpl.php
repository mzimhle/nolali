<?php /* Smarty version 2.6.20, created on 2015-05-22 12:54:08
         compiled from invoice/details.tpl */ ?>
<!DOCTYPE html>
...
<?php else: ?>Add an invoice<?php endif; ?>
            ...
            <div class="portlet-content">
              <form id="validate-basic" action="/invoice/details.php<?php if (isset ( $this->_tpl_vars['invoiceData'] )): ?>?code=<?php echo $this->_tpl_vars['invoiceData']['invoice_code']; ?>
...
" />
		...
		<div class="col-sm-3">
			<div class="list-group">  
				...
				<a class="list-group-item" href="/invoice/item.php?code=<?php echo $this->_tpl_vars['invoiceData']['invoice_code']; ?>
">
