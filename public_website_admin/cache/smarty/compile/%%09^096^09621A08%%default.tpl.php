<?php /* Smarty version 2.6.20, created on 2015-05-22 20:38:32
         compiled from invoice/default.tpl */ ?>
<!DOCTYPE html>
...
<div class="container">
  <div class="content">
	...
	<li class="active">List</li>
      ...
      <div class="row">
        <div class="col-md-12">
		<button class="btn btn-secondary fr" type="button" onclick="link('/invoice/details.php'); return false;">Add a new Invoice</button><br/ ><br />
          <div class="portlet">
