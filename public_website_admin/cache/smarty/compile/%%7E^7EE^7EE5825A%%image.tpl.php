<?php /* Smarty version 2.6.20, created on 2015-05-23 17:57:11
         compiled from catalogue/product/image.tpl */ ?>
<!DOCTYPE html>
...
<div class="container">
  <div class="content">
	...
	<div class="content-header">
		...
		<ol class="breadcrumb">
			<li><a href="/">Home</a></li>
			<li><a href="/catalogue/product/">Products</a></li>
			<li><a href="/catalogue/product/details.php?code=<?php echo $this->_tpl_vars['productData']['product_code']; ?>
        ...
        <div class="col-sm-9">
          <div class="portlet">
            ...
            <div class="portlet-content">
              <form id="validate-basic" action="/catalogue/product/image.php?code=<?php echo $this->_tpl_vars['productData']['product_code']; ?>
" method="POST" data-validate="parsley" class="form parsley-form" enctype="multipart/form-data">			
				<p>Below is a list of images under this product.</p>
				<table class="table table-bordered">	
					...
					<tbody>
					<?php $_from = $this->_tpl_vars['productimageData']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
" width="60" />
							...
							<td>
								<?php if ($this->_tpl_vars['item']['productimage_primary'] == '0'): ?>
									<button value="Make Primary" class="btn btn-danger" onclick="statusSubModal('<?php echo $this->_tpl_vars['item']['productimage_code']; ?>
', '1', 'image', '<?php echo $this->_tpl_vars['item']['product_code']; ?>
'); return false;">Make Primary</button>
							...
							<td>
								<?php if ($this->_tpl_vars['item']['productimage_primary'] == '0'): ?>
									<button value="Delete" class="btn btn-danger" onclick="deleteModal('<?php echo $this->_tpl_vars['item']['productimage_code']; ?>
...
', 'image'); return false;">Delete</button>
		...
		<div class="col-sm-3">
			<div class="list-group">
				<a class="list-group-item" href="/catalogue/product/">
				  <i class="fa fa-asterisk"></i> &nbsp;&nbsp;List
				  <i class="fa fa-chevron-right list-group-chevron"></i>
				</a>			
				<a class="list-group-item" href="/catalogue/product/details.php?code=<?php echo $this->_tpl_vars['productData']['product_code']; ?>
">
